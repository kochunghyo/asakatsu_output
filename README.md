...
----------
**１）インフラにAWSを使用する<br>**
&emsp;&emsp;EC2の導入・独自ドメイン・常時SSL化にも対応させる予定<br>
**２）動画投稿機能<br>**
&emsp;&emsp;当初動画投稿機能も予定していたが、朝散歩中に動画を撮ることは現実的でないので、不要と判断。<br>
&emsp;&emsp;しかし、朝散歩開始及び終了時点の景色などを投稿したいというニーズも想定できるので、短時間（３０秒程度）の動画を投稿できる機能を実装予定<br>
